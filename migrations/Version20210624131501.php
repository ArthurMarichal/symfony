 ...
 */
final class Version20210624131501 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__quack AS SELECT id, auhtor_id, content, created_at FROM quack');
        ...
        $this->addSql('INSERT INTO quack (id, auhtor_id, content, created_at) SELECT id, auhtor_id, content, created_at FROM __temp__quack');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__quack AS SELECT id, auhtor_id, content, created_at FROM quack');
        $this->addSql('DROP TABLE quack');
        $this->addSql('CREATE TABLE quack (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, auhtor_id INTEGER DEFAULT NULL, content CLOB NOT NULL, created_at DATETIME NOT NULL)');
        $this->addSql('INSERT INTO quack (id, auhtor_id, content, created_at) SELECT id, auhtor_id, content, created_at FROM __temp__quack');
        $this->addSql('DROP TABLE __temp__quack');
        $this->addSql('CREATE INDEX IDX_83D44F6F221FC741 ON quack (auhtor_id)');
    }
